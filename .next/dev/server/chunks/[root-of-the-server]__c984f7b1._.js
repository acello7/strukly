...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2f$analytics$2f$dist$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/firebase/analytics/dist/index.mjs [app-route] (ecmascript) <locals>");
;
;
;
;
...
const firebaseConfig = {
    apiKey: ("TURBOPACK compile-time value", "api_key_palsu_sementara"),
    authDomain: ("TURBOPACK compile-time value", "project-palsu.firebaseapp.com"),
    databaseURL: ("TURBOPACK compile-time value", "https://project-palsu.firebaseio.com"),
    projectId: ("TURBOPACK compile-time value", "project-palsu"),
    storageBucket: ("TURBOPACK compile-time value", "project-palsu.appspot.com"),
    messagingSenderId: ("TURBOPACK compile-time value", "123456789"),
    appId: ("TURBOPACK compile-time value", "1:123456789:web:abcdef123456"),
    measurementId: ("TURBOPACK compile-time value", "G-ABCDEF123")
};
// Initialize Firebase
...
"[project]/app/debug/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        const diag = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firebase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getFirebaseDiagnostics"])();
        ...
        const envs = {
            NEXT_PUBLIC_FIREBASE_API_KEY: mask(("TURBOPACK compile-time value", "api_key_palsu_sementara")),
            NEXT_PUBLIC_FIREBASE_AUTH_DOMAIN: mask(("TURBOPACK compile-time value", "project-palsu.firebaseapp.com")),
            NEXT_PUBLIC_FIREBASE_DATABASE_URL: mask(("TURBOPACK compile-time value", "https://project-palsu.firebaseio.com")),
            NEXT_PUBLIC_FIREBASE_PROJECT_ID: mask(("TURBOPACK compile-time value", "project-palsu")),
            NEXT_PUBLIC_FIREBASE_STORAGE_BUCKET: mask(("TURBOPACK compile-time value", "project-palsu.appspot.com")),
            NEXT_PUBLIC_FIREBASE_MESSAGING_SENDER_ID: mask(("TURBOPACK compile-time value", "123456789")),
            NEXT_PUBLIC_FIREBASE_APP_ID: mask(("TURBOPACK compile-time value", "1:123456789:web:abcdef123456")),
            NEXT_PUBLIC_FIREBASE_MEASUREMENT_ID: mask(("TURBOPACK compile-time value", "G-ABCDEF123"))
        };
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c984f7b1._.js.map