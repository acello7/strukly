...
function LoginPage() {
    ...
    const { login, loginWithGoogle } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success(language === "id" ? "Login berhasil!" : "Login successful!");
            router.push("/detect");
        } catch (error) {
            console.error("Login error:", error);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(error.message || (language === "id" ? "Login gagal. Periksa email dan password Anda." : "Login failed. Check your email and password."));
        } finally{
            setIsLoading(false);
        }
    };
    const handleGoogleLogin = async ()=>{
        ...
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success(language === "id" ? "Login dengan Google berhasil!" : "Google login successful!");
            router.push("/detect");
        } catch (error) {
            console.error("Google login error:", error);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(error.message || (language === "id" ? "Login dengan Google gagal." : "Google login failed."));
        } finally{
            setIsLoading(false);
        }
    };
...
//# sourceMappingURL=_abdc21cd._.js.map