export const translations = {
  id: {
    ...
    dokumentasi_struk:
      "Dokumentasi struk otomatis dengan AI untuk UMKM Indonesia. Kelola pendapatan bisnis Anda dengan mudah dan akurat.",
    deteksi_struk_button: "Deteksi Struk",
    lihat_laporan: "Lihat Laporan",
    siap_optimalkan: "Siap Optimalkan Bisnis Anda?",
    bergabung_ribuan:
      "Bergabunglah dengan ribuan UMKM yang telah mempercayai Strukly untuk mengelola dokumentasi pendapatan mereka.",
  ...
  en: {
    ...
    pendapatan: "Revenue",
    dokumentasi_struk:
      "Automatic receipt documentation with AI for Indonesian SMEs. Manage your business income easily and accurately.",
